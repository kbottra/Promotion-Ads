...
var keywords = (
    ...
    var builtinFunctions = (
		...
		"cholcov|Classification(?:BaggedEnsemble|Discriminant(?:\.(?:fit|make|Category))?|Ensemble|KNN(?:\.(?:fit|Category))?|PartitionedEnsemble|PartitionedModel|Tree(?:\.(?:fit|"+
		"Category))?)|classify|classregtree|cluster|clusterdata|cmdscale|combnk|Compact(?:Classification(?:Discriminant|Ensemble|Tree)|Regression(?:Ensemble|Tree)|TreeBagger)|confusionmat|"+
		...
		"rnd|stat)|rcoplot|refcurve|refline|regress|Regression(?:BaggedEnsemble|Ensemble|PartitionedEnsemble|PartitionedModel|Tree(?:\.(?:fit|Category))?)|regstats|relieff|ridge|"+
